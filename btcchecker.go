...
func (c BTCChecker) Check() (Result, error) {
	if c.Attempts < 1 {
		c.Attempts = 1
	}
	if c.Client == nil {
...
func (c BTCChecker) doChecks(req *http.Request) Attempts {
...
func (c BTCChecker) conclude(result Result) Result {
...
func (c BTCChecker) checkDown(resp *http.Response) error {
	...
	currentBlockNum := r.Result.Blocks
...
func (c BTCChecker) getHeightBTC() (int64, error) {
	...
	refBlockNum, err := strconv.ParseInt(string(refBlockNumBytes), 10, 64)
	if err != nil {
		var str = string(refBlockNumBytes[:])
...
func (c BTCChecker) getHeightLTC() (int64, error) {
...
func (c BTCChecker) getHeightBCHABC() (int64, error) {
...
func (c BTCChecker) getHeightBCHABCtokenview() (int64, error) {
