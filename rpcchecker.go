...
// RPCChecker implements a Checker for RPC endpoints.
...
func (c RPCChecker) Check() (Result, error) {
	if c.Attempts < 1 {
		c.Attempts = 1
	}
	if c.Client == nil {
...
func (c RPCChecker) doChecks(req *http.Request) Attempts {
...
func (c RPCChecker) conclude(result Result) Result {
...
func (c RPCChecker) checkDown(resp *http.Response) error {
	// Check status code
